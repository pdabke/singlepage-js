...
const ServiceDirectory = require('../core/service_directory');
...
const AppService = {
  ...
  async getAppInfo(params, clientInfo, userInfo, roles) {
    ...
    resp.user = await ServiceDirectory.getService('UserService').getUserInfo(params, clientInfo, userInfo, roles);
    resp.site = await ServiceDirectory.getService('SiteService').getSiteInfo(params, clientInfo, userInfo, roles);

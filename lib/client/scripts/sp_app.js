...
var _DYNAMIC_SYSTEM_COMPONENTS = ['TreeEditor', 'Spinner', 'Dropdown', 'Tabs', 'TabPane'];
  ...
  if (!SPApp.user) {
    ...
    if (SPApp.user.loginPrereqs && SPApp.user.loginPrereqs.length > 0) {
      ...
      if (SPApp.router.getMatchedComponents().length == 0) {
        ...
        // matching component. I haven't confirmed this yet but this happens
        // for asynch components
